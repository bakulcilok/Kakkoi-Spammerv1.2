...
def sandi():
	...
	print ()
	contoh = input("\033[1;91m[\xf0\x9f\x94\x90] \033[1;91mUSERNAME :\033[1;92m ")
	if contoh == "Muhammad":
		time.sleep(1)
...
def menu():
	...
	if contoh3 == "help":
		...
		print ()
		time.sleep(1)
		print ("				\033[1;91mツ \033[1;97Coming Soon...")
		print ()
		menu()
	elif contoh3 == "quit":
		keluar()
		...
		print ("[\033[1;91m!\033[1;97m] Command", contoh3, "Not Found")
		menu()
# Menu ()
menu()
# Spammer Hououo....
def spam():
	print ()
	print ("			 Pilih Jenis Spam \033[1;91m:")
	print ()
	time.sleep(1)
	print ("	\033[1;93m1\033[1;97m). \033[1;91m> 	\033[1;97mSpam Sms	( \033[1;92mMatahari \033[1;97m)")
	print ("	\033[1;93m2\033[1;97m). \033[1;91m>	\033[1;97mSpam Wa		( \033[1;92mTokopedia \033[1;97m) \033[1;93mBy \033[1;91mXenzi Ganz")
	print ("	\033[1;93m3\033[1;97m). \033[1;91m>	\033[1;97mSpam Call")
	print ("	\033[1;93m4\033[1;97m). \033[1;91m> 	\033[1;97mQuit")
	print ()
	time.sleep(1)
	pilih = input("Number \033[1;91m> \033[1;97m")
	if pilih == "1":
		time.sleep(1)
		print ("Kakkoi Spammer tip: Kakkoi Spammer")
		print ("can be configured at startup, see")
		print ("your the number target contoh : +62858xxx")
		print ("")
		kakkoi_point = 1
		...
		for i in range(jml):
			...
			if 'Success' in sec.text:
				print(f'\033[37m[\033[35m{i+1}\033[37m] \033[33mMessage \033[31m: \033[31mSpam Sms Gagal Terkirim')
				time.sleep(3)
				kakkoi_point += 1
			else:
				print(f'\033[37m[\033[35m{i+1}\033[37m] \033[33mMessage \033[31m: \033[32mSpam Sms Succes Terkirim')
				time.sleep(3)
				kakkoi_point += 1
			time.sleep(1.5)
